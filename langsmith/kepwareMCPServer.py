...
@mcp.tool()
@traceable(run_type="tool", name="get_channel")
...
@mcp.tool()
@traceable(run_type="tool", name="create_channel")
def create_channel(
    channel: str,
...
@mcp.tool()
@traceable(run_type="tool", name="modify_channel")
def modify_channel(
    channel: str,
...
@mcp.tool()
@traceable(run_type="tool", name="get_channel_list")
...
@mcp.tool()
@traceable(run_type="tool", name="delete_channel")
